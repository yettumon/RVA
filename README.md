...
ORCID: https://orcid.org/0009-0009-1329-4363  
DOI: https://doi.org/10.5281/zenodo.20797578
...
| File | `Pantheon_SH0ES.dat` |
| N (total) | 1,701 supernovae |
| N (this analysis) | 665 (IS_CALIBRATOR=0, 0.15<zHD<0.50) |
| Download | https://pantheonplussh0es.github.io/ |

Place `Pantheon_SH0ES.dat` in the same directory as the scripts. This file is excluded from the repository (see `.gitignore`).

**CF3 (Cosmicflows-3)** — *not used directly in this repository.*  
CF3 cross-validation result (c=+378.2 km/s) is cited from Kim 2026a (LA-axis paper).  
CF3 analysis code is located in the LA-axis repository.
...
Along the LA-axis. Zenodo.
https://doi.org/10.5281/zenodo.20797578  
ORCID: https://orcid.org/0009-0009-1329-4363
```
